...
local DataBase = {
  ...
  {"PointCurveLinear",false,false,true,false,true,false,"Linear Point Curve",toneCurve,"Linear Point Curve. *button*",'tonePanel'},
  {"PointCurveMediumContrast",false,false,true,false,true,false,"Medium Contrast Point Curve",toneCurve,"Medium Contrast Point Curve. *button*",'tonePanel'},
  {"PointCurveStrongContrast",false,false,true,false,true,false,"Strong Contrast Point Curve",toneCurve,"Strong Contrast Point Curve. *button*",'tonePanel'},
  ...
  {"SaturationAdjustment",'colorAdjustments',true,true,true,false,false,LOC("$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SaturationAdjustment=Saturation Adjustment"),colorAdjustments,"Changes all color vividness or purity of all colors.",'mixerPanel'},
  ...
  {"ResetSaturationAdjustment",false,false,true,false,true,false,reset..' '..LOC("$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SaturationAdjustment=Saturation Adjustment"),resetColorAdjustments,"Reset to default. *button*",'mixerPanel'},
